...
- [**markdown-review**](plugins/markdown-review/README.md):对话流中的 markdown 文档审阅——`md_doc_open` 在消息流打开本地 md 大浮窗(含 **mermaid 图**),划词批注(输入框嵌在对应段落下方)+ 总评,提交即作为工具结果回传、agent 自动继续。
